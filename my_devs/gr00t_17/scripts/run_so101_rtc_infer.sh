...
RUN_ID="${RUN_ID:-so101_n17_rtc_$(date +%Y%m%d_%H%M%S)}"
RUN_DIR="${GR00T17_ROOT}/outputs/inference/rtc_formal/${RUN_ID}"
...
echo "[OK] SO101 RTC formal inference completed: ${RUN_DIR}"
