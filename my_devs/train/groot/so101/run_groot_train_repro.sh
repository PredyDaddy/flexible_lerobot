...
if [[ "${RESUME}" == "true" ]]; then
  ...
  echo "[INFO] TUNE_LLM: ${POLICY_TUNE_LLM}, TUNE_VISUAL: ${POLICY_TUNE_VISUAL}"
  echo "[INFO] TUNE_PROJECTOR: ${POLICY_TUNE_PROJECTOR}, TUNE_DIFFUSION_MODEL: ${POLICY_TUNE_DIFFUSION_MODEL}"
