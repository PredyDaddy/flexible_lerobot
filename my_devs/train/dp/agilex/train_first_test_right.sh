...
# -----------------------------------------------------------------------------
# Agilex Diffusion Policy 单臂训练脚本（右臂）
# 说明：
# - 风格对齐 my_devs/train/act/agilex/train_first_test_right.sh
