...
RUN_NAME="pi05_lora_high_capacity_eraser_cup_multi_task"

# For PI0.5, the default repo LoRA target only adapts a small q/v/action subset.
# Use all-linear plus a high rank when you want hundreds of millions of trainable adapter params.
LORA_R="${LORA_R:-256}"
...
OUTPUT_DIR="/data/cqy_workspace/flexible_lerobot/outputs/pi05_lora_high_capacity_eraser_cup_multi_task_runs/${RUN_ID}_${MODE}_r${LORA_R}"
