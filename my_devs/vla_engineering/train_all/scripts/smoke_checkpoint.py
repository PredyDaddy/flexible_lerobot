...
def main() -> None:
    parser = argparse.ArgumentParser(description="Load a train_all VLASH PI0.5 checkpoint and run one action chunk.")
    ...
    if not finite:
        raise RuntimeError("Predicted action chunk contains NaN or Inf.")
