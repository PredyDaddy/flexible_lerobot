...
def main() -> None:
    parser = argparse.ArgumentParser(description="Probe one-batch train_all VLASH training memory.")
    ...
    cfg.output_dir = TRAIN_ALL_ROOT / f"tmp/memory_probe_output_{os.getpid()}"
    cfg.validate()
    ...
    result = {
        ...
        "shared_observation": cfg.shared_observation,
