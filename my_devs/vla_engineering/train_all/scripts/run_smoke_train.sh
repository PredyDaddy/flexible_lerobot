...
CONFIG_PATH="${CONFIG_PATH:-${TRAIN_ALL_ROOT}/configs/train/pi05_so101_delay_lora_smoke.yaml}"
OUTPUT_DIR="${OUTPUT_DIR:-${TRAIN_ALL_ROOT}/outputs/pi05_so101_delay_lora_smoke}"
RUN_ID="$(date +%Y%m%d_%H%M%S)"
LOG_DIR="${TRAIN_ALL_ROOT}/logs/${RUN_ID}_pi05_delay_lora_smoke"
...
echo "train_all VLASH PI0.5 delay LoRA smoke run complete."
