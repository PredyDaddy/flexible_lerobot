...
def main() -> int:
    ...
    trt_config = clone_policy_config(checkpoint, device=str(trt_device))
    apply_act_runtime_overrides(
        trt_config,
        policy_n_action_steps=args.policy_n_action_steps,
        policy_temporal_ensemble_coeff=args.policy_temporal_ensemble_coeff,
    ...
    preprocessor, torch_postprocessor = load_pre_post_processors(checkpoint, policy_device="cpu")
    _, trt_postprocessor = load_pre_post_processors(checkpoint, policy_device=str(trt_device))
