...
@TeleoperatorConfig.register_subclass("jz_robot_udp_constant")
@dataclass
class JZRobotUDPConstantTeleopConfig(TeleoperatorConfig):
    """Hardware-free constant action source for JZRobotUDP Phase 2 dry-run recording."""
